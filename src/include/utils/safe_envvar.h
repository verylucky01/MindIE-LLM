...
inline const char *MINDIE_LLM_MAX_IMAGE_FILE_SIZE_MB = "MINDIE_LLM_MAX_IMAGE_FILE_SIZE_MB";
inline const char *MINDIE_LLM_MAX_AUDIO_FILE_SIZE_MB = "MINDIE_LLM_MAX_AUDIO_FILE_SIZE_MB";
inline const char *MINDIE_LLM_MAX_VIDEO_FILE_SIZE_MB = "MINDIE_LLM_MAX_VIDEO_FILE_SIZE_MB";
inline const char *MINDIE_LLM_MAX_TOTAL_MEDIA_SIZE_MB = "MINDIE_LLM_MAX_TOTAL_MEDIA_SIZE_MB";
inline const char *MINDIE_LLM_MAX_IMAGE_PIXELS = "MINDIE_LLM_MAX_IMAGE_PIXELS";

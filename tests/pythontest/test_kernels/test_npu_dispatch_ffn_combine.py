...
class TestDisptachFFNCombine:
    ...
    def generate_hcom(self):
        ...
        if ep_size and tp_size:
            group_ep, group_tp = self.setup_ep_tp(tp_size, ep_size,
                                                  "hccl", None, None)
...
def test_npu_dispatch_ffn_combine_kernel():
    world_size = 16
...
if __name__ == "__main__":
    test_npu_dispatch_ffn_combine_kernel()
    print("Test npu_dispatch_ffn_combine passed!")

...
class TestQwen3ConfigMapWeightToModel(unittest.TestCase):
    """Test cases for Qwen3Config.map_weight_to_model method: transformer format to model format"""

    def test_basic_prefix_replacement(self):
        """Test basic prefix replacement: transformer -> model"""
        result = Qwen3Config.map_weight_to_model("transformer.wte.weight")
        self.assertEqual(result[0], "model.embed_tokens.weight")

    def test_layer_numbering(self):
        """Test layer numbering: h -> layers"""
        result = Qwen3Config.map_weight_to_model("transformer.h.0.attn.c_attn.weight")
    ...
    def test_gate_up_packed_weights(self):
        ...
        result = Qwen3Config.map_weight_to_model("transformer.h.0.mlp.w2_w1.weight")
        # Primary key
    ...
    def test_mlp_c_proj_to_down_proj(self):
        ...
        result = Qwen3Config.map_weight_to_model("transformer.h.0.mlp.c_proj.weight")
    ...
    def test_attn_c_proj_to_o_proj(self):
        ...
        result = Qwen3Config.map_weight_to_model("transformer.h.0.attn.c_proj.weight")
    ...
    def test_all_suffixes_for_qkv(self):
        ...
        result = Qwen3Config.map_weight_to_model("transformer.h.0.attn.c_attn.input_scale")
...
class TestQwen3ConfigMapModelToWeight(unittest.TestCase):
    """Test cases for Qwen3Config.map_model_to_weight method: model format to transformer format"""

    def test_basic_prefix_replacement(self):
        """Test basic prefix replacement: model.layers -> transformer.h"""
        result = Qwen3Config.map_model_to_weight("model.layers.0.self_attn.qkv_proj")
    ...
    def test_o_proj_mapping(self):
        ...
        result = Qwen3Config.map_model_to_weight("model.layers.0.self_attn.o_proj")
    ...
    def test_gate_up_proj_mapping(self):
        ...
        result = Qwen3Config.map_model_to_weight("model.layers.0.mlp.gate_up_proj")
        self.assertEqual(result, "transformer.h.0.mlp.w2_w1")

    def test_down_proj_mapping(self):
        """Test down_proj mapping: down_proj -> c_proj"""
        result = Qwen3Config.map_model_to_weight("model.layers.0.mlp.down_proj")
    ...
    def test_input_layernorm_mapping(self):
        ...
        result = Qwen3Config.map_model_to_weight("model.layers.0.input_layernorm")
    ...
    def test_post_attention_layernorm_mapping(self):
        ...
        result = Qwen3Config.map_model_to_weight("model.layers.0.post_attention_layernorm")
        self.assertEqual(result, "transformer.h.0.ln_2")

    def test_norm_mapping(self):
        """Test norm mapping: model.norm -> transformer.ln_f"""
        result = Qwen3Config.map_model_to_weight("model.norm")
    ...
    def test_embed_tokens_mapping(self):
        ...
        result = Qwen3Config.map_model_to_weight("model.embed_tokens")
        self.assertEqual(result, "transformer.wte")

    def test_lm_head_mapping(self):
        """Test lm_head mapping: model.lm_head -> transformer.wte"""
        result = Qwen3Config.map_model_to_weight("model.lm_head")
        self.assertEqual(result, "transformer.wte")


class TestQwen3ConfigNameMappingRoundTrip(unittest.TestCase):
    ...
    def test_qkv_weight_round_trip(self):
        ...
        to_transformer = Qwen3Config.map_model_to_weight(original)
        back_to_model = Qwen3Config.map_weight_to_model(to_transformer)

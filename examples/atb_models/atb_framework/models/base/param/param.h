...
public:
    ...
    /// A flag indicating whether open flashcomm1.0
    bool enableFlashComm = false;
    /// A flag indicating whether to use pmcc model obfuscation
    ...
    /// The backend of the rope module; refer to `OpBackend` for the supported values
    atb_speed::common::OpBackend ropeBackend = atb_speed::common::OpBackend::ATB;

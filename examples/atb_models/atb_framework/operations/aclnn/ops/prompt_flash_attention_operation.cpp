...
PromptFlashAttentionOperation::~PromptFlashAttentionOperation()
{
    ...
    if (actualSeqLengthsKv_ != nullptr) {
        aclDestroyIntArray(actualSeqLengthsKv_);
...
atb::Status PromptFlashAttentionOperation::CreateAclNNInTensorVariantPack(const atb::VariantPack &variantPack)
{
...
atb::Status PromptFlashAttentionOperation::CreateAclNNOutTensorVariantPack(const atb::VariantPack &variantPack)
{
    AclNNVariantPack &aclnnVariantPack = this->aclnnOpCache_->aclnnVariantPack;

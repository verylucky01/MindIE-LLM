                                      ...
                                      atb::SVector<atb::TensorDesc> &outTensorDescs) const
{
    ...
    if (!param_.isFA) {
        ...
        outTensorDescs.at(0).shape.dims[DIM1] = inTensorDescs.at(DIM0).shape.dims[DIM1]; // S
        outTensorDescs.at(0).shape.dims[DIM2] = inTensorDescs.at(DIM0).shape.dims[DIM2]; // N

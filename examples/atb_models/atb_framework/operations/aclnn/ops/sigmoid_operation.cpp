...
SigmoidOperation::SigmoidOperation(
    const std::string &name) : AclNNOperation(name) {}
...
uint32_t SigmoidOperation::GetInputNum() const
{
    return NUM1;
}


uint32_t SigmoidOperation::GetOutputNum() const
{
    return NUM1;
}

atb::Status SigmoidOperation::CreateAclNNInTensorVariantPack(const atb::VariantPack &variantPack)
{
...
atb::Status SigmoidOperation::CreateAclNNOutTensorVariantPack(const atb::VariantPack &variantPack)
{
    AclNNVariantPack &aclnnVariantPack = this->aclnnOpCache_->aclnnVariantPack;

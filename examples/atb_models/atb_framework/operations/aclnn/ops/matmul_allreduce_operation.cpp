...
atb::Status MatmulAllreduceOperation::CreateAclNNInTensorVariantPack(const atb::VariantPack &variantPack)
{
...
atb::Status MatmulAllreduceOperation::CreateAclNNOutTensorVariantPack(const atb::VariantPack &variantPack)
{
    AclNNVariantPack &aclnnVariantPack = this->aclnnOpCache_->aclnnVariantPack;

                                      ...
                                      atb::SVector<atb::TensorDesc> &outTensorDescs) const
{
    ...
    outTensorDescs.at(0).dtype = param_.isBF16 ? ACL_BF16 : ACL_FLOAT16;
...
atb::Status W8A8Operation::CreateAclNNInTensorVariantPack(const atb::VariantPack &variantPack)
{
    ...
    for (size_t i = 0; i < aclnnVariantPack.aclInTensors.size(); ++i) {
        ...
        if (i == 1 && this->param_.transposeB && atbTensor.desc.format == ACL_FORMAT_FRACTAL_NZ) {
...
atb::Status W8A8Operation::CreateAclNNOutTensorVariantPack(const atb::VariantPack &variantPack)
{
    AclNNVariantPack &aclnnVariantPack = this->aclnnOpCache_->aclnnVariantPack;

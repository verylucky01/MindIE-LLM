...
atb::Status MatmulOperation::CreateAclNNInTensorVariantPack(const atb::VariantPack &variantPack)
{
...
atb::Status MatmulOperation::CreateAclNNOutTensorVariantPack(const atb::VariantPack &variantPack)
{
    AclNNVariantPack &aclnnVariantPack = this->aclnnOpCache_->aclnnVariantPack;

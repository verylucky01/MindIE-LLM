...
{
    LOG_DEBUG_MODEL << opName_ << "MoeDistributeCombineOperation infer shape start";
    ...
    LOG_DEBUG_MODEL << opName_ << "MoeDistributeCombineOperation infer shape end";
    return 0;
}
...
{
    LOG_DEBUG_MODEL << opName_ << " MoeDistributeCombineOperation start";
...
int MoeDistributeCombineOperation::ExecuteAclNNOp(uint8_t *workspace, aclrtStream &stream)
{
    ...
    LOG_DEBUG_MODEL << opName_ << " MoeDistributeCombineOperation end, ret:" << ret;
    return ret;
}

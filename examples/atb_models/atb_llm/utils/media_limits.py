...
def get_max_image_file_size_bytes() -> int:
    return _get_env_int("MINDIE_LLM_MAX_IMAGE_FILE_SIZE_MB", DEFAULT_MAX_IMAGE_FILE_SIZE_MB) * 1024 * 1024


def get_max_audio_file_size_bytes() -> int:
    return _get_env_int("MINDIE_LLM_MAX_AUDIO_FILE_SIZE_MB", DEFAULT_MAX_AUDIO_FILE_SIZE_MB) * 1024 * 1024


def get_max_video_file_size_bytes() -> int:
    return _get_env_int("MINDIE_LLM_MAX_VIDEO_FILE_SIZE_MB", DEFAULT_MAX_VIDEO_FILE_SIZE_MB) * 1024 * 1024

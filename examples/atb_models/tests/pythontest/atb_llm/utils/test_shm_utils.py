...
class TestShmUtils(unittest.TestCase):
    ...
    def test_process_shared_memory_with_pixel_values_only(self, mock_create_shm, mock_encode_shape, mock_encode_shm_name):
        ...
        self.assertEqual(result['pixel_values_videos_shm_name'], -1)
        self.assertEqual(result['pixel_values_videos_shape_value'], -1)
        self.assertEqual(result['video_grid_thw_shm_name'], -1)
        self.assertEqual(result['video_grid_thw_shape_value'], -1)
    ...
    def test_process_shared_memory_with_videos_only(self, mock_create_shm, mock_encode_shape, mock_encode_shm_name):
        ...
        result = process_shared_memory(inputs, "shm_path.txt")
        self.assertEqual(result['pixel_values_shm_name'], -1)
        self.assertEqual(result['pixel_values_shape_value'], -1)
        self.assertEqual(result['image_grid_thw_shm_name'], -1)
        self.assertEqual(result['image_grid_thw_shape_value'], -1)

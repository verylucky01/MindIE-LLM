...
class Glm41vPARunner(MultimodalPARunner):
    ...
    def init_processor(self):
        try:
            ...
            raise RuntimeError("Loading GLM-4.1v Processor failed.") from e
    ...
    def warm_up(self):
        ...
        single_req = self._request_from_token_glm4_1v(
            input_ids,
            max_output_length,
            self.block_size,
            req_idx=0,
...
if __name__ == '__main__':
    ...
    pa_runner = Glm41vPARunner(**input_dict)

...
DeepSeek-R1-Distill-Qwen-14B 为Deepseek利用由 DeepSeek-R1 生成的推理数据，对密集型模型Qwen2.5进行了微调。评估结果显示，提炼后的小型密集模型在基准测试中的表现非常出色。
...
| ----------------- |----------------------------|-----------------------------| ---- | ---- | --------------- | --------------- | -------- | --------- | ------------ | -------- | ------- | -------------- | --- | ------ | ---------- | --- | --- | --- |
| DeepSeek-R1-Distill-Qwen-14B           | 支持world size 1,2,4,8       | 支持world size 2,4,8              | √    | √    | √               | √               | √        | ×         | ×            | ×        | ×       | √              | ×   | ×      | x       | x | x | x |
...
- [DeepSeek-R1-Distill-Qwen-14B](https://modelers.cn/models/State_Cloud/DeepSeek-R1-Distill-Qwen-14B)

...
## 硬件要求
部署DeepSeek-V3模型用W8A8量化权重进行推理则至少需要2台Atlas 800I A2 (8\*64G)。
...
主节点
```
bash run.sh pa_bf16 full_CEval 5 1 deepseek_v3 {/path/to/weights/DeepSeek-V3} {/path/to/xxx/ranktable.json} 16 2 0 {主节点IP}
# 0 代表从0号卡开始推理，之后的机器依次从8，16，24。
```
副节点
```
bash run.sh pa_bf16 full_CEval 5 1 deepseek_v3 {/path/to/weights/DeepSeek-V3} {/path/to/xxx/ranktable.json} 16 2 8 {主节点IP}
# 0 代表从0号卡开始推理，之后的机器依次从8，16，24。
```
...
主节点
```
bash run.sh pa_bf16 full_GSM8K 8 deepseek_v3 {/path/to/weights/DeepSeek-V3} {/path/to/xxx/ranktable.json} 16 2 0 {主节点IP}
# 0 代表从0号卡开始推理，之后的机器依次从8，16，24。
```
副节点
```
bash run.sh pa_bf16 full_GSM8K 8 deepseek_v3 {/path/to/weights/DeepSeek-V3} {/path/to/xxx/ranktable.json} 16 2 8 {主节点IP}
# 0 代表从0号卡开始推理，之后的机器依次从8，16，24。
```
...
主节点
```
bash run.sh pa_bf16 performance [[256,256]] 1 deepseek_v3 {/path/to/weights/DeepSeek-V3} {/path/to/xxx/ranktable.json} 16 2 0 {主节点IP}
# 0 代表从0号卡开始推理，之后的机器依次从8，16，24。
```
副节点
```
bash run.sh pa_bf16 performance [[256,256]] 1 deepseek_v3 {/path/to/weights/DeepSeek-V3} {/path/to/xxx/ranktable.json} 16 2 8 {主节点IP}
# 0 代表从0号卡开始推理，之后的机器依次从8，16，24。
```

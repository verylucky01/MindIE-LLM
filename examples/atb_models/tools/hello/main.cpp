...
{
#ifdef USE_TORCH_RUNNER
    ASD_LOG(DEBUG) << "c10_npu::NPUCachingAllocator::init";
...
int main(int argc, const char *argv[])
{
    ...
    if (ret != 0) {
        ...
        ASD_LOG(DEBUG) << "ExecuteSync success";
    }
